...
from PySide6.QtWidgets import QApplication, QFrame, QGridLayout, QHBoxLayout, QLCDNumber, QLabel, QListWidget, QListWidgetItem, QMainWindow, QPushButton, QSizePolicy, QStackedWidget, QStatusBar, QVBoxLayout, QWidget
